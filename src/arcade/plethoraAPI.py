...
class PlethoraAPI():
    ...
    def __init__(self):
        ...
        self.tetris_btn = UIButton(20, (30 + self.title.rect.height)*2, "Tetris", font_menu_item, background=(128, 128, 128), padding=4)
        ...
        if self.game:
            ...
            if event.type == MOUSEBUTTONDOWN and event.button == 1:
                ...
                if not self.game:
                    ...
                    elif self.tetris_btn.rect.collidepoint(event.pos):
                        self.launch_game("tetris")
    ...
    def onrender(self) -> None:
        ...
        if self.dirty:
            ...
            if not self.game:
                ...
                self.draw_ui_el(self.tetris_btn)
            flip = True
            self.dirty = False
